...
bool AnimationBaseTest::init()
{
    ...
    //auto anipath = FileUtils::getInstance()->fullPathForFilename("AnimationBaseTest/AnimationBaseTest.json");
    //auto texturepath = FileUtils::getInstance()->fullPathForFilename("AnimationBaseTest/texture.json");
    ...
    //const auto dragonBonesData = _factory.loadDragonBonesData(anipath);
    //_factory.loadTextureAtlasData(texturepath);
